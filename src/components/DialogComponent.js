// src/components/DialogComponent.js
...
class DialogComponent {
    ...
    createDialog() {
      ...
      this.closeButton = this.scene.add
        ...
        // Add the character image to the right side of the dialog
    this.characterImage = this.scene.add
    .image(this.x + this.width / 2 + 50, this.y, this.imageKey)
    .setDisplaySize(100, 100) // Adjust size as needed
    .setOrigin(0.5)
